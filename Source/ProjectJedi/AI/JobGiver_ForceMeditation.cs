...
public class JobGiver_ForceMeditation : ThinkNode_JobGiver
{
    ...
    public override float GetPriority(Pawn pawn)
    {
        ...
        return forcePool.CurLevelPercentage < 0.5 ? 9.5f : 0f;
    }
    ...
    public override ThinkResult TryIssueJobPackage(Pawn pawn, JobIssueParams jobParams)
    {
        ...
        if (sensitiveTrait != null || compForce.ForceData.TicksUntilMeditate > Find.TickManager.TicksAbs)
        {
            return ThinkResult.NoJob;
        }

        return forcePool.CurCategory > ForcePoolCategory.Strong
            ? ThinkResult.NoJob
            : base.TryIssueJobPackage(pawn, jobParams);
    }

    private static IntVec3 resolveMeditationLocation(Pawn pawn, out Thing padResult)
    {
    ...
    protected override Job TryGiveJob(Pawn pawn)
    {
        ...
        return padResult != null
            ? new Job(DefDatabase<JobDef>.GetNamed("PJ_ForceMeditationJob"), padResult)
            : new Job(DefDatabase<JobDef>.GetNamed("PJ_ForceMeditationJob"), c);
    }
}